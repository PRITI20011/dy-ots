            ...
            <div class="container content">
                <div class="about-block">
                    <div class="row">
                        ...
                        <p > Wireframe design is a critical step in the web and app development process. It involves creating a visual guide that represents the skeletal framework of a website or application. Wireframes focus on the layout and functionality rather than colors, graphics, or detailed content. They help to establish the structure and relationship between the different components of the user interface.</p>
                    </div>
                </div>
                            ...
                            <div class="col-lg-7">
                                <div class="ul-icon white-tick">
                                    <ul>
                                        ...
                                        <li>
                                            <h4>Wireframes serve as a shared reference point for designers, developers, project managers, and clients, facilitating better collaboration and communication throughout the project.
                                            </h4>
