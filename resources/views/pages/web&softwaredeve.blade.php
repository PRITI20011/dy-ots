                    ...
                    <p style="text-align: justify">OrianaTech Solutions is a leading <strong> Web & Software </strong>
                        ...
                        which the businesses are facing but also will have an edge over your competitors</p>
                                <p style="text-align: justify">We have a team of specialist <strong> Web & Software </strong>
                                    ...
                                    Web Sockets, SVN, etc. Dedicated Developers for each requirements like Portal,
                                    Web Portal, CMS, E-Commerce, CRM, ERP, Database, Document Management System Development,
                                    Saas Application and Much more.</p>
                            </div>
                       </div>
                    </div>
                </div>
                            ...
                            <div class="ul-icon white-tick">
                                <ul style="list-style-type:disc">
                                    ...
                                    <li>
                                     ...
                                     <li>
                                        <p>Customization of the Application.</p>
                                    </li>
                                    <li>
                                        <p>Enhancement of the Application.</p>
                                    </li>
                        ...
                        <div class="row">
                            <div class="col-md-10 offset-1">
                                ...
                                <p style="text-align: justify">We get the best human resources to power our quality driven Web Development Services.
                                    ...
                                    clients in such a way that they meet client’s objectives with ease.</p>
                            </div>
                       </div>
                    </div>
                </div>
                                                ...
                                                <ul>
                                                    <li>
                                                        ...
                                                        <p style="text-align: justify">We Build an interactive, customized and High-Quality websites for
                                                            our clients which help them to succeed in their business.</p>
                                                    </li>
                                                    <li>
                                                        <h4>Web Portals and CMS Development</h4>
                                                        <p style="text-align: justify">CMS allows complete freedom to the end-users in terms
                                                            of editing or managing their sites without the help from a Web
                                                            developer or a Web designer.</p>
                                                    </li>
                                                    <li>
                                                        <h4>ECommerce Website Development</h4>
                                                        <p style="text-align: justify">We are a team of professionals having hands-on experience
                                                            in E-commerce Portal Development.</p>
                                                    </li>
                                                    <li>
                                                        <h4>Website Modernization</h4>
                                                        <p style="text-align: justify">There is a factor of cost cutting in every business.
                                                            But, the need for moving on with the latest technology
                                                            is also needed. We suggest to constantly updating the website for
                                                            the marketing point of view. Here is where we step in.
                                                            We help in modernizing your website according to the
                                                            latest technology.</p>
                                                    </li>
                                                    <li>
                                                        <h4>Custom CRM Software Development</h4>
                                                        <p style="text-align: justify">Helping your business drive success making everyone part of your
                                                            organization. We allow you engage and nurture more customers within
                                                            Sales and Customer Network.</p>
                                                    </li>
                                                </ul>
                                            </div>
                                    </div>
                                            ...
                                            <div class="ul-icon blue-tick">
                                                <ul>
                                                    ...
                                                    <li>
                                                        ...
                                                        <p style="text-align: justify">ERP software Integration improves productivity, increase efficiencies,
                                                            decrease costs and streamline processes.</p>
                                                    </li>
                                                    <li>
                                                        <h4>Custom Software Development</h4>
                                                        <p style="text-align: justify">Software Consulting Services At OrianaTech Help Modern-Day Enterprise
                                                            To Keep Pace With Rapidly Changing Market Demands & Technology Trends.</p>
                                                    </li>
                                                    <li>
                                                        <h4>Database Development</h4>
                                                        <p style="text-align: justify">OrianaTech offers bespoke database development solutions to
                                                            streamline and systematize the business processes.</p>
                                                    </li>
                                                    <li>
                                                        <h4>Document Management System Development</h4>
                                                        <p style="text-align: justify">OrianaTech offers bespoke document management system development
                                                            solutions to streamline and systematize the business processes.</p>
                                                    </li>
                                                    <li>
                                                        <h4>SaaS Application Development</h4>
                                                        <p style="text-align: justify">Our SaaS Applications offers you a common infrastructure which is
                                                            compatible with multiple devices and functional as a
                                                            web application.</p>
                                                    </li>
                                                ...
                                                <ul>
                                                    <li>
                                                        ...
                                                        <p style="text-align: justify">We Build an interactive, customized and High-Quality websites
                                                            for our clients which help them to succeed in their business.</p>
                                                    </li>
                                                    <li>
                                                        <h4>WordPress Development</h4>
                                                        <p style="text-align: justify">Get fully functional WordPress websites for your business with our
                                                            WordPress development services.</p>
                                                    </li>
                                                    <li>
                                                        <h4>Drupal Development</h4>
                                                        <p style="text-align: justify">Drupal is a user-friendly open-source CMS which gives the users the
