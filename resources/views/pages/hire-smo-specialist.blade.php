                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-md-20 offset-0.5">
                                <h1 class=" text-uppercase"><b>Hire a dedicated SMO services Expert</b></h1>
                                <br>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4">
                            <div class="ul-icon white-tick ">
                                <ul style="list-style-type:disc;margin-left: 15%">
                                    ...
                                    <li>
                                        <p style="text-align: justify;">Grow your following organically. You will have a loyal & active following/community.</p>
                                    </li>
                                    <li>
                                        <p style="text-align: justify;">High quality & relevant content with infographics & videos posted daily on all channels.</p>
                                    </li>
                                    <li>
                                        <p style="text-align: justify;">Cost-Effective. We charge less than traditional marketing agencies.</p>
                                    </li>
                                </ul>
                            </div>
                        </div>
                        <div class="col-lg-4">
                                <div class="ul-icon white-tick">
                                    ...
                                    <li>
                                        <p style="text-align: justify;">Tracking of all the important social media metrics on a weekly basis.</p>
                                    </li>
                                    <li>
                                        <p style="text-align: justify;">Daily & weekly reports will be shared with you.</p>
                                    </li>
                                    <li>
                                        <p style="text-align: justify;">Reduce cost per lead by 150 percent.</p>
                                    </li>
                                    <li>
