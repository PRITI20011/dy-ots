...
<div class="header-banner bg-grad has-mask">
    <div class="ax-inner-banner">
        <div class="banner-intro">
            <h2>Helping You Gain Competitive Advantage</h2>
        </div>
    </div>
</div>
</header>
<section class="section-padding">
    <div class="container">
        <div class="row">
            <div class="col-md-20 offset-0.5 text-center">
                <div class="head-sec">
                    <h2>Grow with us and we will grow with you.</h2>
                </div>
                ...
                <p style="text-align: justify">The team at OrianaTech Solution Pvt Ltd consists of
                    ...
                    projects with exceptional precision and the highest quality.
                ...
                <div class="col-xs-12 list-item">
                    <article class="job-list">
                        <div class="job-information">
                            <div class="inner">
                                <h5 class="job-title"><a href="job-details.html" rel="bookmark">Full-Stack Developer</a>
                                </h5>
                                <div class="job-date-author">
                                    posted 2 weeks ago
                                </div>
                                <div class="job-metas">
                                    <div class="job-location"><i class="fas fa-map-marker-alt"></i> Baner,Pune,
                                        Maharashtra</div>
                                </div>
                            </div>
                            <div class="ali-right hidden-xs">
                                <a class="btn btn-outline" href="job-details.html">Browse Job</a>
                            </div>
                        </div>
                    </article>
